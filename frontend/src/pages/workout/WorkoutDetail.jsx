...
export default function WorkoutDetail() {
    ...
    const loadPlan = async () => {
      ...
      try {
        if (currentRole === "USER" && !id) {
          const res = await api.get("/users/me/workout-plan");
          const data = unwrapResponseData(res);
          if (data) {
            setPlan(normalizeWorkoutPlan(data));
          } else {
            setPlan(null);
            setEmptyMessage("No workout plan has been assigned to you yet.");
          }
          return;
        }
        ...
        if (!id) {
          ...
          setEmptyMessage(currentRole === "USER"
            ...
            : "Pick a workout plan to view its details.");
          return;
        }
        ...
        setError(currentRole === "USER" && !id
          ? "Unable to load your assigned workout plan."
  ...
  const goBack = () => navigate(currentRole === "USER" ? "/" : "/workout-plan");
          ...
          <Container fluid>
            <div className="d-flex align-items-center justify-content-between mb-3">
              ...
              <div className="text-end">
                <h2 className="mb-0">{currentRole === "USER" ? "My Workout Plan" : "Workout Detail"}</h2>
            ...
            {!loading && !error && !emptyMessage && !id && currentRole !== "USER" && (
              <div className="alert alert-warning">
                Pick a workout plan from <Link to="/workout-plan">Workout Plan Master</Link> to view its details.
              </div>
            )}
